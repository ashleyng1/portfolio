...
#delimit;
asdoc regress marriageduration husbandage scale_husband_mincome wifeage scale_wife_mincome children husbandedu divorcetype wifeedu custody unilateral,
	nest
	stat(r2_a)
	dec(3)
	save(AsdocTable.doc)
	replace;
asdoc regress marriageduration husbandage wifeage scale_wife_mincome children husbandedu divorcetype wifeedu custody unilateral,
	nest
	stat(r2_a)
	dec(3)
	save(AsdocTable.doc)
	append;
asdoc regress marriageduration husbandage scale_husband_mincome wifeage children husbandedu divorcetype wifeedu custody unilateral,
	nest
	stat(r2_a)
	dec(3)
	save(AsdocTable.doc) 
	append;
asdoc regress marriageduration husbandage scale_husband_mincome wifeage scale_wife_mincome children husbandedu wifeedu custody unilateral,
	nest
	stat(r2_a)
	dec(3)
	save(AsdocTable.doc) 
	append;
asdoc regress marriageduration husbandage scale_husband_mincome wifeage scale_wife_mincome children husbandedu divorcetype wifeedu unilateral,
	nest
	stat(r2_a)
	dec(3)
	save(AsdocTable.doc) 
...
asdoc regress marriageduration husbandage scale_husband_mincome wifeage scale_wife_mincome children husbandedu divorcetype wifeedu unilateral,
	...
	save(AsdocTable.doc) 
	append;
asdoc regress marriageduration husbandage scale_family_mincome wifeage children husbandedu divorcetype wifeedu unilateral, 
	nest
	stat(r2_a)
	dec(3)
	save(AsdocTable.doc), replace
#delimit

*Check multicollinearity for the last two regression models
regress marriageduration husbandage scale_wife_mincome scale_husband_mincome wifeage children husbandedu divorcetype wifeedu unilateral
vif 
